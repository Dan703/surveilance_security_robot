...
1. A **servo motor** sweeps the ultrasonic sensor across an approximate **200° field of view**, panning back and forth like a radar dish.
2. At each angle, the **ultrasonic sensor (HC-SR04)** pings and measures the distance to the nearest object in front of it.
3. The distance (in cm) is shown in real time on a **display**.
